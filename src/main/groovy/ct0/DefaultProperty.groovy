...
abstract class DefaultProperty implements UIEntity {
    ...
    @Deprecated int getUnk23() { virtual }
    @Deprecated void setUnk23(int unk23) { this.virtual = unk23 }
